...
#./customizer.sh your.package.name DataItemType [MyApplication] -> Sin los []
#
# Where `your.package.name` is your app ID (should be lowercase) and `DataItemType` is used for the
# name of the screen, exposed state and data base entity (should be PascalCase). You can add an
